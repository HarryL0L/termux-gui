        ...
        withSystemListenersAndCleanup(am, wm) {
            ...
            while (! Thread.currentThread().isInterrupted) {
                ...
                when (m.methodCase) {
                    ...
                    Method.MethodCase.SURFACETRACKPAD -> handleView.surfaceTrackpad(m.surfaceTrackpad)
                    Method.MethodCase.SURFACESETCURSOR -> handleView.surfaceSetCursor(m.surfaceSetCursor)
                    Method.MethodCase.SURFACESETCURSORIMAGE -> handleView.surfaceSetCursorImage(m.surfaceSetCursorImage)
